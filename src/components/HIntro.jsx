function HIntro() {
  return (
    <div className="flex flex-wrap lg:ml-20 justify-center md:justify-start max-w-xl mt-0 md:my-20">
      ...
      <div className="w-full flex justify-center md:justify-start">
        <button className="px-6 py-3 bg-theme text-white font-bold mt-12 flex items-center space-x-3">
          <div>
            <svg
              width="22"
              height="22"
